...
mongoose.connect("mongodb+srv://kanarimochi:Vnp7MGmqIy8L9ija@cluster0.y5o0l.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    ...
    .catch((error)=>{
        console.log(error)
        console.error("Failure: Connected to MongoDB")
    })
    ...
    UserModel.findOne({email:req.body.email})
        .then((savedData)=>{
            if(savedData){
                ...
                //ユーザーが存在しない場合の処理
                res.render("error",{message:"/blog/loginのエラー:ユーザーが存在していません"})
            }          
        })
        .catch((error)=>{
